<footer class="page-footer">
		...
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--whybuy">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Speciality</a>
					</li>
					<li class="footer-nav__item">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:xxxxxxxxxxx">xxxxxxxxxxx</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:avenuefashion@yahoo.com" class="email__addr">avenuefashion@yahoo.com</a>
				</div>
			</div>
	...
	<div class="banners">
		<div class="container clearfix">
			...
			<span>We Serve</span><br> What Suits You Best
			</div>
